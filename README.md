...
> Run `10_coreclass_mlp_gat_selftrain_EMA_modified_dynamic_topk.ipynb` to reproduce the best Kaggle F1 score achieved in this project (0.53311 on AWS, 0.53470 on Colab). The `Amazon_products` folder should be located in the same directory as the `.ipynb` files.
